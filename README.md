...
### [NL-to-SQL Agent](https://github.com/Mohona19/nl-sql-agent) &nbsp;·&nbsp; `Claude API` `Snowflake` `Streamlit` `Python`
...
### [GTM Attribution Engine](https://github.com/Mohona19/gtm-attribution-engine) &nbsp;·&nbsp; `Python` `dbt` `Claude API` `Snowflake`
...
### [Growth Intelligence Pipeline](https://github.com/Mohona19/groupon-growth-intelligence) &nbsp;·&nbsp; `Python` `Yelp Fusion API`
End-to-end B2B lead sourcing, enrichment & scoring pipeline. Includes validation framework and SDR pitch generation.

### [Revenue Forecasting Dashboard](https://github.com/Mohona19/revenue-forecasting-dashboard) &nbsp;·&nbsp; `Python` `Prophet` `Streamlit`
...
### [Pricing Optimization Simulation](https://github.com/Mohona19/ai-pricing-optimization-simulation) &nbsp;·&nbsp; `Python` `scikit-learn` `XGBoost`
...
### [Superstore Profitability Dashboard](https://github.com/Mohona19/superstore-profitability-dashboard) &nbsp;·&nbsp; `Power BI` `SQL` `DAX`
...
| **AI & Agents** | Anthropic Claude API · LangChain · scikit-learn · XGBoost · Prophet · SHAP · Streamlit |
...
| Metric | Result |
|---|---|
| 💰 Commercial portfolio managed | **$1.3B+** |
| 👥 Subscribers analyzed | **35M+** |
| ⚡ Manual reporting eliminated | **10+ hrs/week** |
| 📈 Forecast accuracy improvement | **+15%** |
| 📉 Monthly churn reduction | **-8%** |
| 💡 Margin uplift identified | **$182K** |
...
🌐 [tasmiaafroze.com](https://tasmiaafroze.com) &nbsp;·&nbsp; 💼 [LinkedIn — Tasmia Afroze](https://www.linkedin.com/in/tasmia-afroze) &nbsp;·&nbsp; 📧 [afrozetasmia19@gmail.com](mailto:afrozetasmia19@gmail.com)
